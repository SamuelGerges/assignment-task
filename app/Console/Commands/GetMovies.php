...
class GetMovies extends Command
{
    ...
    private function attachGenres($result, Album $movie)
    {
    ...
    private function attachActors(Album $movie)
    {
        $response = Http::get(config('services.tmdb.base_url') .
    ...
    private function getImages(Album $movie)
    {
        $response = Http::get(config('services.tmdb.base_url') .
